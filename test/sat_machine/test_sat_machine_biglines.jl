function test_sat_machine_timming_biglines(n_clauses)
    gmap = GraphMap.new()
    ...
    #SatMachine.plot_gpaths(machine, "biglines_$(n_clauses-1)_")
...
for i in 2:4
    n_clauses = i
    n_vars = n_clauses*3
    total_time = @elapsed test_sat_machine_timming_biglines(n_clauses)
