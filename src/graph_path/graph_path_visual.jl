module GraphPathVisual
    ...
    function draw_line!(diagram :: PathDiagram, step :: Step)
        ...
        for node_id in PathCollectionLines.get_ids_step(diagram.graph.table_lines, step)
            node = PathCollectionLines.get_node(diagram.graph.table_lines, node_id)
    ...
    function draw_node!(diagram :: PathDiagram, node :: PathDocNode)
